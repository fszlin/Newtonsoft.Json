properties { 
  ...
  $majorVersion = "8.0"
  $majorWithReleaseVersion = "8.0.2.2"
  $nugetPrelease = $null
  $version = GetVersion $majorWithReleaseVersion
  $packageId = "Newtonsoft.Json.Unity"
  ...
  $builds = @(
    @{Name = "Newtonsoft.Json.Unity"; BuildFunction = "MSBuildBuild"; Constants="NET35;UNITY"; FinalDir="Net35"; NuGetDir = "net35"; Framework="net-2.0"}
  )
}
